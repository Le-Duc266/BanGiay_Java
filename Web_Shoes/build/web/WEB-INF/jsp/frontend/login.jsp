                                        ...
                                        <div class="widget-main">
                                            ...
                                            <form action="/Web_Shoes/backendSigup" onsubmit="return myFunction()" method="POST">
                                                <fieldset>
                                                    ...
                                                    <label class="block clearfix">
                                                        <span class="block input-icon input-icon-right">
                                                            <input type="hidden" name="maNhanVien" class="input-control type_1" id="maNhanVien" value="0"/>
                                                        </span>

                                                    </label>
                                                        <label class="block clearfix">
                                                        <span class="block input-icon input-icon-right">
                                                            <input type="email" class="form-control" placeholder="Họ Tên" name="hoTen" id="hoTen" />
                                                            <i class="ace-icon fa fa-envelope"></i>
                                                        </span>
                                                        <div class="invalid-feedback" style="display:block;font-size:15px;color: red"></div>
                                                    </label>
