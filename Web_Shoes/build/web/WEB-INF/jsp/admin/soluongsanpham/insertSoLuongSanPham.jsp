                                ...
                                <div class="col-12 grid-margin">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form class="form-sample" action="/Web_Shoes/admin/soluongsanpham/saveSoLuongSanPham" method="post">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <p>${ctsp.chiTietSanPhamPK.maSanPham}</p>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <select name="maSize" class="form-control">
                                                                        <c:forEach items="${sizeSanPhams}" var="si">
                                                                            <option value="<fmt:formatNumber value="${si.maSize}"></fmt:formatNumber>">${si.size}</option>
                                                                        </c:forEach>
                                                                    </select>
                                                            </div>
                                                        </div>
